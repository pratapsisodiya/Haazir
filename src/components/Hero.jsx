...
export default function Hero() {
  return (
    <section id="top" className="relative overflow-hidden bg-paper">
      ...
      <div className="relative mx-auto max-w-[1180px] px-5 pt-12 pb-20 sm:px-8 lg:pt-20 lg:pb-28">
        <div className="grid items-center gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.82fr)]">
          ...
          <div className="relative mx-auto w-full max-w-[26rem] lg:max-w-none">
            ...
            <figure className="absolute -bottom-7 -left-4 w-[15.5rem] rounded-2xl border border-line bg-white/95 p-3.5 shadow-[0_18px_44px_-14px_rgb(14_16_19_/_0.25)] backdrop-blur-sm sm:-left-8 sm:w-[17.5rem]">
